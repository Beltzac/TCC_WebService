function [x popx fitvals] = gaGo2(ffit, nbits, gaoptions, varargin)
...
global imgDataGlobal;
for j=1:nger

    fits = pararrayfun(4,@(a)loop(ffit,popx,a),1:n , "ErrorHandler" , @eh); 
...
% loop reimplemented as a function
function mret = loop (ffit,popx,i) 
        mret =  ffit(popx(i,:));
end        
